...
const helpOutput = {
  headers: ['audit-runner', 'Commands:', 'Options:'],
  commands: ['audit-runner user-flow  Load, Run and Store user-flow audits'],
  options: ['--version  Show version number', '-v, --verbose  Run with verbose logging', '-h, --help     Show help'],
};
