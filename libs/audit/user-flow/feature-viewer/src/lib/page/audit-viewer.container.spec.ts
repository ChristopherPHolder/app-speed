...
describe('AuditViewerContainer', () => {
  ...
  it('shows a loading indicator until the audit result is rendered', async () => {
    ...
    const request = http.expectOne('/api/audits/user-flow/run-123/result');
  ...
  it('selects the step encoded in the URL fragment once results load', async () => {
    ...
    const container = fixture.debugElement.query(By.directive(AuditViewerContainer))
      .componentInstance as AuditViewerContainer;
