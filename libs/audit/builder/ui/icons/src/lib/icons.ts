export const LIGHTHOUSE_BADGE_ICON_NAME = 'lighthouse-badge';

export const LIGHTHOUSE_BADGE_SVG = `
...
export const PUPPETEER_BADGE_ICON_NAME = 'puppeteer-badge';

export const PUPPETEER_BADGE_SVG = `
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" focusable="false">
    <defs>
