...
export async function sendAuditResults(connectionId: string): Promise<PostToConnectionCommandOutput> {
    const config:  ApiGatewayManagementApiClientConfig = {
        region: 'us-east-1',
        endpoint: 'https://5ag9xf0aab.execute-api.us-east-1.amazonaws.com/ufo/@connections',
    }
